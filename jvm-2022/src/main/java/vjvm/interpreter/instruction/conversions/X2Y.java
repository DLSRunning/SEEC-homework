...
public class X2Y<T,U> extends Instruction {
  ...
  public static X2Y<Integer,Byte> I2B(ProgramCounter pc, MethodInfo method){
    return new X2Y<>(OperandStack::popInt,X2Y::i2b,OperandStack::pushByte,"i2b");
  }

  public static X2Y<Integer,Character> I2C(ProgramCounter pc, MethodInfo method){
    return new X2Y<>(OperandStack::popInt,X2Y::i2c,OperandStack::pushChar,"i2c");
  }

  public static X2Y<Integer,Short> I2S(ProgramCounter pc, MethodInfo method){
    return new X2Y<>(OperandStack::popInt,X2Y::i2s,OperandStack::pushShort,"i2s");
  }
  ...
  public static Character i2c(int value){
    return (char) value;
  }
